...
def main(args):
    ...
    dev_examples = mb.vec_minibatch(fake_dev + true_dev, word_dict, char_dict, args, False,
                                    char=True, sent_ling=False, doc_ling=False)
    ...
    dev_acc = evals.eval_vec_batch(eval_fn, dev_examples, char=True, sent_ling=False, doc_ling=False)
    ...
    for epoch in range(args.epoches):
        ...
        for batch_x, _ in train_examples:
            ...
            train_loss = train_fn(batch_rnn, batch_cnn, batch_word_mask, batch_sent_mask, batch_y)
            n_updates += 1
            if n_updates % 100 == 0 and epoch > 6:
                ...
                if dev_acc[3] > best_fsc and dev_acc[0] > best_acc:
                    ...
                    # util.save_params('char_params_%.2f' % dev_acc[3], params,
